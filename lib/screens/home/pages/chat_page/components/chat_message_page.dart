  ...
  Widget getChatInputField() {
    return Column(children: [
      Container(
        ...
        decoration: BoxDecoration(color: Colors.white.withOpacity(0.8), boxShadow: [
          BoxShadow(
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(
            Icons.play_arrow,
            color: Colors.red.withOpacity(message.isSender ? 1 : 0.4),
          ),
          Expanded(
            child: Padding(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(
        message.text,
        style:
            TextStyle(color: message.isSender ? Colors.white : Colors.black.withOpacity(0.4)),
      ),
    );
  }
}
